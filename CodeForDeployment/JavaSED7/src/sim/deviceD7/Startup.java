...
public class Startup implements DeviceStartup {
	...
	private static void setUpNode(Device deviceInfo) {
		...
		LogicDisplayTempController logicDisplayTempControllerImpl = new LogicDisplayTempController(
				myPubSub, deviceInfo, ui, (Context) myContext);
		new Thread(logicDisplayTempControllerImpl).start();
	...
	private static Device setUpDeviceInfo() {
		...
		abilities.add("DisplayTempController");
